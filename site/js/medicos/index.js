const initFn = (e, options = { }) => {
    ...
    let nomeSelect = document.querySelector("select.nome-select");
    let crmSelect = document.querySelector("select.crm-select");
    let especSelect = document.querySelector("select.especializacao-select");
